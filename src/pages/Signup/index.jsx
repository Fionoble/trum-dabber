...
import { signUp, authError, isAuthenticated } from "../../services/auth";
...
export default function Signup() {
  ...
  return (
    <div className="signup-container min-h-screen flex items-center justify-center bg-gray-100 p-4">
